...
{#if href}
	<!-- eslint-disable svelte/no-navigation-without-resolve -- href is expected to be pre-resolved via resolve() by the consumer -->
	<a
		bind:this={ref}
		data-slot="button"
	...
	<!-- eslint-enable svelte/no-navigation-without-resolve -- href is expected to be pre-resolved via resolve() by the consumer -->
{:else}
	<button
		bind:this={ref}
		data-slot="button"
